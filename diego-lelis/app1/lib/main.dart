import 'package:app1/detalhe_receita_page.dart';
import 'package:app1/model/receita_model.dart';
...
class _ReceitaHomeState extends State<ReceitaHome> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Receitas da Mamãe Dominguinhas"),
          centerTitle: true,
        ),
        body: SafeArea(
          child: Container(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) {
              return DetalheReceitaPage(receita: receita,);
            },
          ),
        );
      },
