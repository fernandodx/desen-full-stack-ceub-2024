  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: Column(
        children: [
          Image.asset(widget.receitaModel.assetImg,
            height: 120,
          ...
          Expanded(
            child: ListView.separated(itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: Icon(Icons.adb_rounded, color: Colors.lightGreen,),
                title: Text("${qtdIngrediente} ${ingrediente.tipoMedida} - ${ingrediente.nome}"),
              );
            },
                separatorBuilder: (context, index) => Divider(color: Colors.lightGreen,),
