...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4278217318),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4288541163),
      ...
      tertiaryFixed: Color(4288541163),
      onTertiaryFixed: Color(4278198302),
      tertiaryFixedDim: Color(4286633423),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4280648060),
      ...
      tertiaryFixed: Color(4280648060),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4286633423),
      onTertiary: Color(4278204213),
      tertiaryContainer: Color(4278210636),
      onTertiaryContainer: Color(4288541163),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4286962131),
      onTertiary: Color(4278196761),
      tertiaryContainer: Color(4282949273),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(4286962131),
      onTertiaryContainer: Color(4278190080),
      ...
      tertiaryFixed: Color(4288804592),
      onTertiaryFixed: Color(4278190080),
      tertiaryFixedDim: Color(4286962131),
