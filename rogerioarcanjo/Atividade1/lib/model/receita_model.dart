class ReceitaModel {
  ...
  ReceitaModel({required this.nome, required this.assetImg, required this.urlImg, required this.listaIngrediente});

  static List<ReceitaModel> listaReceita = [
    ReceitaModel(
        nome: "Torta de Chocolate",
        assetImg: "asset/Torta.jpg",
        urlImg:
