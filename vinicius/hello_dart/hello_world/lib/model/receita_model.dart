class ReceitaModel {
  ...
  ReceitaModel({required this.nome, required this.urlImg, required this.listaIngrediente, required this.imgAsset});

  static List<ReceitaModel> listaReceita = [
    ReceitaModel(
        nome: "Torta de Chocolate",
        imgAsset: "assets/torta.jpg",
        urlImg:
